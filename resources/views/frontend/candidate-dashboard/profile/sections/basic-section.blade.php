<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <form action="{{ route('candidate.profile.basic-info.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <x-image-preview :height="200" :width="200" :src="$candidate?->image" />
                ...
                <div class="form-group">
                    <label class="font-sm color-text-mutted mb-10"> CV
                        <span class="text-primary">{{ $candidate?->cv ? '( CV Attached )' : '' }}</span> </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group select-style">
                            ...
                            <select
                                class="form-control form-icons select-active {{ $errors->has('experience_level') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                type="text" name="date_of_birth" value="{{ $candidate?->dob }}">
