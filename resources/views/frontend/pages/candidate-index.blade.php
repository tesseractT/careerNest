                                    ...
                                    <div class="card-grid-2 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="employers-info align-items-center justify-content-center mt-15">
                                                <div class="row">
                                                    <div class="col-9"><span class="d-flex align-items-center"><i
                                                                class="fi-rr-marker mr-5 ml-0"></i><span
                                                                class="font-sm color-text-mutted">{{ $candidate->companyCountry->name }}</span></span>
                                                    </div>
                                                            ...
                                                            class="d-flex justify-content-end align-items-center"><span
                                                                class="font-sm"><a
                                                                    ...
                                                                    target="_blank" rel="noopener noreferrer"><i
                                                                        class="fi-rr-link mr-5"></i>Resume</a></span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
