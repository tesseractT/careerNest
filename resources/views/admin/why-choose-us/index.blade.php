                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div role="iconpicker" data-icon="{{ $whyChooseUs?->icon_one }}" data-align="left"
                                            name="icon_one" class="{{ hasError($errors, 'icon_one') }}"></div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'subtitle_one') }}"
                                                name="subtitle_one"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div role="iconpicker" data-icon="{{ $whyChooseUs?->icon_two }}" data-align="left"
                                            name="icon_two" class="{{ hasError($errors, 'icon_two"') }}"></div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Subtitle One</label>
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'subtitle_two') }}"
                                                name="subtitle_two"
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div role="iconpicker" data-icon="{{ $whyChooseUs?->icon_three }}"
                                            data-align="left" name="icon_three"
                                ...
                                <div class="col-md-10">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ hasError($errors, 'title_three') }}"
                                                name="title_three"
