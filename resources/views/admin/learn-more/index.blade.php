                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.learn-more.update', 1) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <x-image-preview :height="200" :width="300" :src="$learn?->image" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'sub_title') }}"
                                    name="sub_title" value="{{ old('sub_title', $learn?->sub_title) }}">
